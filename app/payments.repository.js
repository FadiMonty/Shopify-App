...
export const createConfiguration = async (config) => {
  try {
    ...
    return console.log("Error in CreateConfiguration", error);
  }
};
export const updateConfiguration = async (config) => {
  try {
    ...
    return console.log("Error in UpdateConfiguration", error);
  }
};
// export const getConfiguration = async (sessionId, config) => {
//   try {
//     const configuration = await prisma.configuration.create({ sessionId: sessionId, ...config });
//     return configuration;
//   } catch (error) {
//     return console.log("Error in getConfiguration", error);
//   }
// };
